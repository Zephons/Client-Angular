...
import { FileUploadStatus } from '../core/model/file-upload.status';
import { NotificationType } from '../core/enumeration/notification-type.enum';
import { CustomHttpResponse } from '../core/model/custom-http-response';
import { Role } from '../core/enumeration/role.enum';
...
export class UserComponent implements OnInit, OnDestroy {
  ...
  public onResetPassword(emailForm: NgForm): void {
    ...
    this.subscriptions.push(
      this.userService.resetPassWord(emailAddress).subscribe(
        ...
        () => emailForm.reset() // this is the reason why we put the form as parameter of the function because I want to be able to reset the form at the end.
      )
    );
  }
  ...
  public get isAdminOrAssistant(): boolean {
    return this.isAdmin || this.getUserRole() === Role.ASSISTANT;
  }
  ...
  public displayUserRole(role: Role): string {
    switch(role) {
      case Role.USER:
        return "User";
      case Role.ASSISTANT:
